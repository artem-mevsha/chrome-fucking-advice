  ...
  <div class="advice">
    <div class="advice__aligner">
      ...
      <transition v-if="error" name="advice-slide" mode="out-in">
        <div class="advice__content" :key="error">
          <h1 class="advice__text">
            <fga-advice-link :advice="error" @click.native="checkConnection" />
          </h1>
        </div>
      </transition>
      <!-- Error content End -->
      ...
      <transition v-else-if="advice" name="advice-slide" mode="out-in">
        <div class="advice__content" :key="advice.id">
          <h1 class="advice__text">
            <fga-advice-link :advice="advice.html" @click.native="nextAdvice" />
          </h1>
...
import FgaAdviceLink from './AdviceLink';
